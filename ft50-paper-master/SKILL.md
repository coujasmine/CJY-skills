...
## 与子技能协同
需要逐段重写时，调用对应子 skill：
- Introduction：`ft50-introduction`
- Theoretical Background：`ft50-theoretical-background`
- Theory and Hypotheses：`ft50-theory-and-hypotheses`
- Mechanism Model：`ft50-mechanism-model`
- Methods and Results：`ft50-methods-and-results`
- Discussion and Contribution：`ft50-discussion-and-contribution`
- AI/ML 专项：`ft50-ai-ml`
- Construct and Measurement 专项：`ft50-construct-and-measurement`
